...
void setup_impl() {
  ...
  digitalWrite(LED_0_R_PIN, LOW);
  digitalWrite(LED_0_Y_PIN, LOW);
  digitalWrite(LED_0_G_PIN, LOW);

  digitalWrite(LED_1_R_PIN, LOW);
  digitalWrite(LED_1_Y_PIN, LOW);
  digitalWrite(LED_1_G_PIN, LOW);

  digitalWrite(LED_2_R_PIN, LOW);
  digitalWrite(LED_2_Y_PIN, LOW);
  digitalWrite(LED_2_G_PIN, LOW);
}
